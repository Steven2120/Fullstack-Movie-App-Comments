...
//creates function with 3 params. it logs error and if url starts with /api return the following json
...
//creates function with 3 params that if eq.originalUrl.startsWith "/api" and if error.isOperational is true return following json error msgs
...
// Solution 1
//creates function with err param that initiates 2 variables hold error messages and return a given error msg
...
module.exports = (err, req, res, next) => {
  ...
  //sets err.statuscode with value of err.statuscode or 500
  err.statusCode = err.statusCode || 500;
  //sets err.status with value of err.status or error
